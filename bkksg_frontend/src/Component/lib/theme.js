const theme = {
  day: {
    ...
    gradient : {
        ...
        linear : "linear-gradient(69deg, rgba(173,148,191,0.6) 0%, rgba(145, 180, 173, 0.6) 68%, rgba(226,220,185,0.4) 91%) ",
        footer: "radial-gradient(circle, rgba(238,204,209,1) 20%, rgba(74,166,141,0.1) 87%)"
      },

    colors : {
      main : "#B3BFCE",
      content : "rgba(255,255,255,0.1)",
      index : "rgba(100,110,130,1)",
    ...
    glass : {
      ...
      border : {
        radius : "0.5rem",
        line : "1px rgba(200, 200, 200, 0.7) solid"
      }
    }
  },
  ...
  night: {
        gradient : {
            radial : "radial-gradient(circle, rgba(40,100,138,0.7) 16%, rgba(55,45,78,0.7) 87%)",
            linear : "linear-gradient(69deg, rgba(28,37,84,0.6) 4%, rgba(102,48,108,0.6) 64%, rgba(30,110,136,0.6) 100%)",
            footer: "radial-gradient(circle, rgba(40,80,108,1) 28%, rgba(55,45,78,0.1) 87%)",
          },

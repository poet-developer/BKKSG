  ...
  render() {
    return (
      <Html lang='ko'>
        ...
        <meta property="og:description" content={`이로가 비껴서서 생각하고 설계하고 만드는, 움직이는 화랑 | 시, 수필, 미술, 시각, 기획`}/>
        <meta property="og:image" content={'/thumbnail/bkksg_thumbnail.png' }/>
        <meta name="twitter:card" content="summary"/>
        <meta name="twitter:title" content={`비껴서기 | 비껴서기`} />
        <meta name="twitter:description" content={`이로가 비껴서서 생각하고 설계하고 만드는, 움직이는 화랑 | 시, 수필, 미술, 시각, 기획`}/>

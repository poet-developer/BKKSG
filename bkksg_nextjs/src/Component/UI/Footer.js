    ...
    <>
      ...
      >
        ...
        <span style={{ display: "none" }}>
          비껴서서 생각하고 설계하고 만드는 林이로의 움직이는 화랑| Poet, Essay,
          Art, Visual, Installation, Project
        </span>
        <LogoContainer className="footer-logo-container">
          ...
          <div className="sns-icon">
            ...
            <a
              className="icon-item"
              href="https://github.com/poet-developer"
              target="_blank"
              rel="noopener noreferrer"
            >
              <Image
            ...
            <div
              ...
              style={{ color: theme.common.color }}
            >
              <h5 style={{ marginBottom: "0.5rem" }}>| CONTACT US</h5>
              <span style={{ letterSpacing: "0.10rem", fontSize: "0.8rem" }}>
        ...
        <div className="footer-copyright">
          @ 2022 Copyright All Rights Reserved By IROLIM
        </div>
      </FooterCotainer>
    </>
  );

  ...
  return (
    <Head>
     <title>{id ? `${title} | BKKSG`: `비껴서기 | ${title}`}</title>
        ...
        <meta property="og:description" content={id ? `${title} | ${topic}` :`이로가 비껴서서 생각하고 설계하고 만드는, 움직이는 화랑 | 글, 시각, 설치, 기획`}/>
        ...
        <meta name="twitter:description" content={id ? `${title} | ${topic}`:`이로가 비껴서서 생각하고 설계하고 만드는, 움직이는 화랑 | 글, 시각, 설치, 기획`}/>
